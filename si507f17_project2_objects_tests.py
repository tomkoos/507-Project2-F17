...
class Problem2Song(unittest.TestCase):
	...
	def tearDown(self):
		pass
>>>>>>> e9799499c3b9d2406c412c07e52a0d04717b3569
...
class Problem1(unittest.TestCase):
    ...
    def test_constructor_media(self):
        self.assertEqual(type(self.m1inst.title), type(
            u"s"), "Testing whether inst var is a unicode string (all web " +
            "data is unicode, generally)")
        self.assertEqual(type(self.m1inst.author), type(
            u"s"), "Testing whether inst var is a unicode string (all web " +
            "data is unicode, generally)")
        self.assertEqual(type(self.m1inst.itunes_URL), type(
            u"s"), "Testing whether inst var is a unicode string (all web " +
            "data is unicode, generally)")
        self.assertEqual(type(self.m2inst.itunes_id), type(34))
        self.assertEqual(self.m2inst.title, "Ratatouille")
    ...
    def test_str_method(self):
        self.assertEqual(self.m1inst.__str__(),
...
class Problem2Movie(unittest.TestCase):
    ...
    def test_movie_str(self):
        self.assertEqual(self.movie_sample.__str__(),
                         "Ratatouille by Pixar & Brad Lewis")

    def test_movie_repr(self):
        self.assertEqual(self.movie_sample.__repr__(),
                         "ITUNES MEDIA: 265250067")
